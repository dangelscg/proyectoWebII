@ModelType IEnumerable(Of musica.artista)
...
<body id="page4">
    ...
    <table>
        ...
        @For Each item In Model
            ...
            @<tr>
                <td>
                    @Html.DisplayFor(Function(modelItem) currentItem.id_artista)
                </td>
                <td>
                    @Html.DisplayFor(Function(modelItem) currentItem.artista1)
                </td>
                <td>
        ...
        <header>
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="~/artista">Artista</a></li>
        ...
        <article id="content">
            ...
            <div class="col-2">
                ...
                <div class="img-box fl">
                    <a href="images/01.jpg" rel="prettyPhoto[pp_gal]">
                        <img src="images/gallery5.jpg" alt=""><br>
                        Gallery 1
                    </a>
                </div>
                <div class="img-box fl lst">
                    <a href="images/02.jpg" rel="prettyPhoto[pp_gal]">
                        <img src="images/gallery2.jpg" alt=""><br>
                        Gallery 2
                    </a>
                </div>
                <div class="img-box fl">
                    <a href="images/03.jpg" rel="prettyPhoto[pp_gal]">
                        <img src="images/gallery4.jpg" alt=""><br>
                        Gallery 3
                    </a>
                </div>
                <div class="img-box fl lst">
                    <a href="images/04.jpg" rel="prettyPhoto[pp_gal]">
                        <img src="images/gallery1.jpg" alt=""><br>
                        Gallery 4
                    </a>
                </div>
                <div class="img-box fl">
                    <a href="images/05.jpg" rel="prettyPhoto[pp_gal]">
                        <img src="images/gallery3.jpg" alt=""><br>
                        Gallery 5
                    </a>
                </div>
                <div class="img-box fl lst">
                    <a href="images/06.jpg" rel="prettyPhoto[pp_gal]">
                        <img src="images/gallery6.jpg" alt=""><br>
                        Gallery 6
                    </a>
                </div>
                <div class="img-box fl">
                    <a href="images/07.jpg" rel="prettyPhoto[pp_gal]">
                        <img src="images/gallery8.jpg" alt=""><br>
                        Gallery 7
                    </a>
                </div>
                <div class="img-box fl lst">
                    <a href="images/08.jpg" rel="prettyPhoto[pp_gal]">
                        <img src="images/gallery7.jpg" alt=""><br>
                        Gallery 8
                    </a>
                </div>
            </div>
