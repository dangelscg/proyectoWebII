@ModelType IEnumerable(Of musica.recientes)
...
<body id="page3">
    ...
    <table>
        ...
        @For Each item In Model
            ...
            @<tr>
                <td>
                    @Html.DisplayFor(Function(modelItem) currentItem.id_recientes)
                </td>
                <td>
                    @Html.DisplayFor(Function(modelItem) currentItem.reciente)
                </td>
                <td>
        ...
        <header>
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="~/reciente">Reciente</a></li>
