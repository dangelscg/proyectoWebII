@ModelType IEnumerable(Of musica.persona)
...
<body id="page6">
    ...
    <table>
        ...
        @For Each item In Model
            ...
            @<tr>
                <td>
                    @Html.DisplayFor(Function(modelItem) currentItem.id_perosna)
                </td>
                <td>
        ...
        <header>
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="~/persona">Contacts</a></li>
                </ul>
            </nav>
        ...
        <article id="content">
            ...
            <div class="col-2">
                ...
                <form action="" id="form1">
                    <fieldset>
                        ...
                        <label class="msg">Comentario<textarea></textarea></label>
            ...
            <div class="col-3">
                ...
                <ul class="contacts blo">
                    <li><span>Continente:</span>Sud America</li>
                    <li><span>Ciudad:</span>Bolivia</li>
                    <li><span>Ciudad:</span>Potosi</li>
                    <li><span>Telefono:</span>65335976</li>
                    <li><span>Correo:</span><a href="#">axel_zorro@hotmail.com</a></li>
                </ul>
                <h2>Miscellaneous</h2>
